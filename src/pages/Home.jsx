  ...
  return (
    <div className="w-full" style={{ background: "black" }}>
      ...
      >
        ...
        {/* Education */}
        <div className="mb-16">
          <h3 className="subhead-text text-center mb-8 text-white">
            Education
          </h3>
          <div
          ...
          >
            <div className="text-center">
              ...
              <p className="text-gray-400">{personalInfo.education.duration}</p>
      ...
      >
        <div className="text-center mb-16">
          <h1 className="head-text text-white" style={{ marginBottom: "50px" }}>
            Highlights
          </h1>

          <p className="text-gray-300 mt-2 leading-relaxed max-w-3xl mx-auto">
        ...
        <div className="flex flex-wrap my-20 gap-16 justify-center">
          {projects.map((project, index) => (
            <div
              className="lg:w-[400px] w-full p-5 rounded-xl"
              key={project.name}
              style={{
                background: "linear-gradient(to right, #111111, #1a1a1a)",
              }}
