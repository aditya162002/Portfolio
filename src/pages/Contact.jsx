...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-full flex flex-col px-4 sm:px-0 justify-center items-center">
        <h1 className="head-text text-white text-center sm:text-left underline">
          Get in Touch
        </h1>
